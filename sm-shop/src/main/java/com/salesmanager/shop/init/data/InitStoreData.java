	...
	public void initInitialData() throws ServiceException {
		...
		ProductType generalType = productTypeService.getProductType(ProductType.GENERAL_TYPE);
		 ...
		 Category optical = new Category();
		    ...
		    novs.setCode("topicos");
		    novs.setVisible(false);

		    CategoryDescription novsEnglishDescription = new CategoryDescription();
		    novsEnglishDescription.setName("Tópicos");
		    novsEnglishDescription.setCategory(novs);
		    novsEnglishDescription.setLanguage(en);
		    novsEnglishDescription.setSeUrl("topicos");

		    CategoryDescription novsEnglishDescription2 = new CategoryDescription();
		    novsEnglishDescription2.setName("Tópicos");
		    novsEnglishDescription2.setCategory(novs);
		    novsEnglishDescription2.setLanguage(es);
		    novsEnglishDescription2.setSeUrl("topicos");
		    ...
		    descriptions2.add(novsEnglishDescription2);
		    ...
		    descriptions4.add(techEnglishDescription2);
			...
			descriptions3.add(webEnglishDescription2);
			...
			fictiondescriptions.add(fictionEnglishDescription2);
			...
			businessdescriptions.add(businessEnglishDescription2);
			...
			clouddescriptions.add(cloudEnglishDescription2);
		    ...
		    try {
		    	ClassPathResource classPathResource = new ClassPathResource("/demo/clirbest.jpg");
		    	InputStream inStream = classPathResource.getInputStream();
		    	this.saveFile(inStream, "clirbest.jpg", product2);
		    } catch(Exception e) {
		    	LOGGER.error("Error while reading demo file clirbest.jpg",e);
		    }
		    ...
		    try {
		    	ClassPathResource classPathResource = new ClassPathResource("/demo/arcabosa.jpg");
		    	InputStream inStream = classPathResource.getInputStream();
		    	this.saveFile(inStream, "arcabosa.jpg", product3);
		    } catch(Exception e) {
		    	LOGGER.error("Error while reading demo file arcabosa.jpg",e);
		    }
		    ...
		    try {
		    	ClassPathResource classPathResource = new ClassPathResource("/demo/acemetacina.jpg");
		    	InputStream inStream = classPathResource.getInputStream();
		    	this.saveFile(inStream, "acemetacina.jpg", product4);
		    } catch(Exception e) {
		    	LOGGER.error("Error while reading demo file acemetacina.jpg",e);
		    }
		   ...
		   // productAvailabilityService.create(availability5);
		    ...
		    try {
		    	ClassPathResource classPathResource = new ClassPathResource("/demo/aciclovir.jpg");
		    	InputStream inStream = classPathResource.getInputStream();
		    	this.saveFile(inStream, "aciclovir.jpg", product5);
		    } catch(Exception e) {
		    	LOGGER.error("Error while reading demo file aciclovir.jpg",e);
		    }
		    ...
		    try {
		    	...
		    	ClassPathResource classPathResource = new ClassPathResource("/demo/botiquin.jpg");
		    	InputStream inStream = classPathResource.getInputStream();
		    	this.saveFile(inStream, "botiquin.jpg", product6);
		    } catch(Exception e) {
		    	LOGGER.error("Error while reading demo file botiquin.jpg",e);
		    }
		    ...
		    //Create a customer (user name[nick] : araguacaima password : password)

		    Customer customer = new Customer();
			customer.setMerchantStore(store);
			customer.setEmailAddress("araguacaima@gmail.com");
...
//		    billing.setCountryCode(canada.getIsoCode());
			...
			order.setCustomerEmailAddress("araguacaima@gmail.com");
			order.setDelivery(delivery);
			order.setIpAddress("ipAddress" );
			order.setMerchant(store);
			order.setOrderDateFinished(new Date());//committed date
			
			orderStatusHistory.setComments("Recibimos su orden");
			...
			orderProductDownload.setOrderProductFilename("Nombre del archivo");
