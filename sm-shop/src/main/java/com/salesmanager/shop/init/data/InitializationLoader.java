    ...
    public void init() {
        ...
        try {
            ...
            if (initializationDatabase.isEmpty()) {
                ...
                config.setDisplayCustomerSection(true);
                config.setDisplayContactUs(true);
                config.setDisplayStoreAddress(true);
                config.setDisplayAddToCartOnFeaturedItems(true);
                config.setDisplayCustomerAgreement(true);
                config.setAllowPurchaseItems(true);
                config.setDisplaySearchBox(true);
